...
#define ADC_BUFF_SIZE            (uint16_t)((DSP_BUFF_PACKET_SIZE * 16U))                  // ADC buffer size in samples
#define ADC_BUFF_HALF_SIZE       (uint16_t)((ADC_BUFF_SIZE / 2U))                          // ADC buffer half size
